export const queryKeys = {
  ...
  programSnapshots: (id: string) =>
    [...queryKeys.programs, id, 'snapshots'] as const,
  programChanges: (id: string) =>
    [...queryKeys.programs, id, 'changes'] as const,

  // Changes
  changes: ['changes'] as const,
  changesList: (params?: { limit?: number }) =>
